 ...
 * 
 * NOTE: Balances are managed at worklet-level (WorkletService/walletStore).
 * This hook works directly with walletStore - no adapter needed.
 * 
 * Supports:
